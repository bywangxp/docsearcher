...
//					edit             : true,  						      // 是否可以编辑文件（裁剪）
			...
			this.funDisposePreviewHtml = function(file, e){
				...
				var infohtml='<p id="ti">标题：<input type="text" placeholder="我的文档标题"></p>';
					infohtml+='<p>简介：<br><textarea style=" width:240px;margin-left: 70px;margin-top:-30px;" rows="5" columes="30">';
					infohtml+='文档简介';
					infohtml+='</textarea></p>';
					infohtml+='<p>分类：<select name="" id="">';
					infohtml+='					<option value="">选择分类</option>';
					infohtml+='					<option value="">课件</option>';
					infohtml+='					<option value="">演示</option>';
					infohtml+='					<option value="">科技</option>';
					infohtml+='					<option value="">文学</option>';
					infohtml+='					<option value="">情感</option>';
					infohtml+='					<option value="">教程</option>';
					infohtml+='					<option value="">其他</option>';
					infohtml+='		   </select></p>';

					infohtml+='<p>标签：&nbsp;&nbsp;&nbsp;<input type="text" placeholder="多个标签请有逗号隔开"></p>';
					
								
					infohtml+='类型:<form method="get" style="margin-left: 40px;margin-top:-32px">';
					infohtml+='		<input type="radio" name="document" value="common"/>公开文档&nbsp;&nbsp;任何人都可检索、阅读<br>';
					infohtml+='		<input type="radio" name="document" value="privite"/>私有文档&nbsp;&nbsp;仅自己可见';
					infohtml+='	</form>';
					infohtml+='售价：<div class="myInputNumber">';
					infohtml+='</div>';
				...
				if (file.type.indexOf("image") == 0) {
					...
					html += '			<div id="uploadFile_'+file.index+'" class="upload_file">'+infohtml+' </div>';                                                                 
					// html += '		</div>';
					// html += '	</a>';
